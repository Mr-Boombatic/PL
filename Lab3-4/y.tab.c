...
{
  "$end", "error", "$undefined", "OPENTAG", "CLOSETAG", "VALUE", "END",
  "$accept", "commands", "command", "opentag", "closetag", "value", "end", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 8:
#line 95 "task4.y" /* yacc.c:1646  */
    {
	char startTag[100];
	sprintf(startTag, "%s", (yyvsp[0])); // помещаем в буфер занчение тега
	if (startTag[0] == '<')
...
#line 1444 "y.tab.c" /* yacc.c:1646  */
  ...
  case 10:
#line 250 "task4.y" /* yacc.c:1646  */
    {
	strcat(tagResult, (yyvsp[0]));
}
#line 1452 "y.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 253 "task4.y" /* yacc.c:1646  */
    {
	if (strlen(openedTags) != 0) {
