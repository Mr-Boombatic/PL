...
{
  "$end", "error", "$undefined", "DAY_OF_WEEK", "YEAR", "DAY", "MONTH",
  "SIGNAL", "$accept", "commands", "command", "recognize_day",
  "recognize_header", "recognize_day_of_week", "recognize_signal", YY_NULLPTR
};
#endif
...
#line 97 "example.y" /* yacc.c:1646  */
    {
            dayOfWeek[counterForDayOfWeek] = (yyvsp[0]);
